		...
		<!-- Main -->
			<div id="main">
				...
				<!-- One -->
					<section id="one">
						<header class="major">
							<h2><strong>“Imagination is more important than knowledge. For knowledge is limited to all we now know and understand, while imagination embraces the entire world, and all there ever will be to know and understand.”</strong></h2>
					<p><h3> -Albert Einstein <h3></p>
						</header>
					...
					<section id="two">
						...
						<div class="row">
							...
							<article class="6u$ 12u$(xsmall) work-item">
								...
								<h3>Beaglebone Black Controlled Light</h3>
								<p>Because who <i>really</i> wants to physically flip a switch anymore?</p>
							</article>
							<article class="6u 12u$(xsmall) work-item">
								<a href="images/fulls/03.jpg" class="image fit thumb"><img src="images/thumbs/03.jpg" alt="" /></a>
								<h3>Servo Controlled Pan &amp; Tilt System</h3>
								<p>Remote vision is a pretty spiffy thing, especially when using a PS3 controller.</p>
							</article>
							<article class="6u$ 12u$(xsmall) work-item">
								<a href="images/wake_up_light.jpg" class="image fit thumb"><img src="images/wake_up_light.jpg" alt="" /></a>
								<h3>Wake-up Light</h3>
								<p>If the sun doesn't want to wake up, I'll make a fake one that does.</p>
							</article>
							<!--<article class="6u 12u$(xsmall) work-item">
				...
				<!-- Three -->
					<section id="three">
						<h2>Get In Touch</h2>
						<p>Feel free to send me a message with any questions or comments you may have!</p>
						<div class="row">
							...
							<div class="4u$ 12u$(small)">
								<ul class="labeled-icons">
									...
									<li>
										...
										<a href="mailto:m.dres344@gmail.com" target="_top">m.dres344@gmail.com</a>
									</li>
								</ul>
							</div>
						</div>
